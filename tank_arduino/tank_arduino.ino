...
// Pin definitions
#define FLOW_SENSOR_PIN 2         // Pin connected to the flow sensor
#define ULTRASONIC_TRIG_PIN 3     // Pin connected to the ultrasonic sensor trigger
#define ULTRASONIC_ECHO_PIN 4     // Pin connected to the ultrasonic sensor echo
...
// SoftwareSerial for communication with NodeMCU
SoftwareSerial nodemcu(6, 7); // RX, TX
...
void setup() {
  ...
  // Start SoftwareSerial communication with NodeMCU
  nodemcu.begin(9600);
...
void loop() {
  ...
  nodemcu.print("Flow Rate: ");
  nodemcu.print(flowRate);
  nodemcu.print(" L/min, Water Level: ");
